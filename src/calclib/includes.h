...
typedef enum {
	...
	DISPLAY_FORMAT_DECIMAL_ONLY		= 1 << 3,	
	DISPLAY_FORMAT_BEAUTIFY			= 1 << 4,
	DISPLAY_FORMAT_NONASCII			= 1 << 5,
	DISPLAY_FORMAT_TAGS			= 1 << 6,
	DISPLAY_FORMAT_ALLOW_NOT_USABLE		= 1 << 7,
	DISPLAY_FORMAT_SHORT_UNITS		= 1 << 8,
	DISPLAY_FORMAT_LONG_UNITS		= 1 << 9,	
	DISPLAY_FORMAT_HIDE_UNITS		= 1 << 10	
} DisplayFormatFlags;
