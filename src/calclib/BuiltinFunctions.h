...
DECLARE_BUILTIN_FUNCTION(AtomicSymbolFunction);
DECLARE_BUILTIN_FUNCTION(AtomicNumberFunction);
DECLARE_BUILTIN_FUNCTION(AtomicNameFunction);
DECLARE_BUILTIN_FUNCTION(AtomicWeightFunction);
DECLARE_BUILTIN_FUNCTION(AtomicDensityFunction);
DECLARE_BUILTIN_FUNCTION(MeltingPointFunction);
DECLARE_BUILTIN_FUNCTION(BoilingPointFunction);
DECLARE_BUILTIN_FUNCTION(AtomicRadiusFunction);
DECLARE_BUILTIN_FUNCTION(CovalentRadiusFunction);
DECLARE_BUILTIN_FUNCTION(IonicRadiusFunction);
DECLARE_BUILTIN_FUNCTION(AtomicVolumeFunction);
DECLARE_BUILTIN_FUNCTION(SpecificHeatFunction);
DECLARE_BUILTIN_FUNCTION(FusionHeatFunction);
DECLARE_BUILTIN_FUNCTION(EvaporationHeatFunction);
DECLARE_BUILTIN_FUNCTION(TermalConductivityFunction);
DECLARE_BUILTIN_FUNCTION(PaulingFunction);
DECLARE_BUILTIN_FUNCTION(IonisingEnergyFunction);
DECLARE_BUILTIN_FUNCTION(OxidationStatesFunction);
DECLARE_BUILTIN_FUNCTION(ElectronicConfigurationFunction);
DECLARE_BUILTIN_FUNCTION(AtomInfoFunction);
